package com.example.application.config.CustomAnnotation;

import com.alibaba.fastjson.JSON;
import com.example.application.model.MyLogClass;
import com.example.application.model.SysCmsLog;
...
public class SysLogAspect {
    ...
    //定义切点 @Pointcut
    //在注解的位置切入代码
    @Pointcut("@annotation( com.example.application.config.CustomAnnotation.MyLog)")
