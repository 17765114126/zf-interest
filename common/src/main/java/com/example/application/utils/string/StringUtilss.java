...
import com.example.application.utils.Func;
import com.example.application.utils.support.StrFormatter;
...
public class StringUtilss extends org.springframework.util.StringUtils {
	...
	public static boolean isBlank(final CharSequence cs) {
		return !StringUtilss.hasText(cs);
	}
	...
	public static String join(Collection<?> coll) {
		return StringUtilss.collectionToCommaDelimitedString(coll);
	}
	...
	public static String join(Collection<?> coll, String delim) {
		return StringUtilss.collectionToDelimitedString(coll, delim);
	}
	...
	public static String join(Object[] arr) {
		return StringUtilss.arrayToCommaDelimitedString(arr);
	}
	...
	public static String join(Object[] arr, String delim) {
		return StringUtilss.arrayToDelimitedString(arr, delim);
	}
	...
	public static String random(int count) {
		return StringUtilss.random(count, RandomType.ALL);
	}
