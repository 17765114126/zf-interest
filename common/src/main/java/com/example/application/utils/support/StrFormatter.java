package com.example.application.utils.support;
    ...
    public static String format(final String strPattern, final Object... argArray) {
        ...
        for (int argIndex = 0; argIndex < argArray.length; argIndex++) {
            ...
            if (delimIndex == -1) {
                 ...
                 * 转义符
                 */
                if (delimIndex > 0 && StringPool.BACK_SLASH.equals(strPattern.charAt(delimIndex - 1))) {
                    /**
                     * 双转义符
                     */
                    if (delimIndex > 1 && StringPool.BACK_SLASH.equals(strPattern.charAt(delimIndex - 2))) {
