package com.example.springboot.controller.watermark;
...
public class ImageRemarkUtil {
    ...
    public static void main(String[] args) {
        String srcImgPath = "F:/1.jpg";
        String logoText = "朵拉专用";
        String iconPath = "F:/logo.jpg";

//        String targerTextPath = "f:/qie_text.jpg";
//        String targerTextPath2 = "d:/qie_text_rotate.jpg";

        String targerIconPath = "F:/qie_rotate.jpg";
        String targerIconPath2 = "F:/qie_icon_rotate.jpg";
...
//        System.out.println("给图片添加水印文字结束...");
        ...
        setImageMarkOptions(0.1f, 500, 1,null , Color.red);
        // 给图片添加水印图片
