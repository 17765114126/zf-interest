...
public class DateUtilss {
	 ...
	 * java 8 时间格式化
	 */
	public static final DateTimeFormatter DATETIME_FORMATTER = DateTimeFormatter.ofPattern(DateUtilss.PATTERN_DATETIME);
	public static final DateTimeFormatter DATE_FORMATTER = DateTimeFormatter.ofPattern(DateUtilss.PATTERN_DATE);
	public static final DateTimeFormatter TIME_FORMATTER = DateTimeFormatter.ofPattern(DateUtilss.PATTERN_TIME);
	...
	public static Date plusYears(Date date, int yearsToAdd) {
		return DateUtilss.set(date, Calendar.YEAR, yearsToAdd);
	}
	...
	public static Date plusMonths(Date date, int monthsToAdd) {
		return DateUtilss.set(date, Calendar.MONTH, monthsToAdd);
	}
	...
	public static Date plusWeeks(Date date, int weeksToAdd) {
		return DateUtilss.plus(date, Period.ofWeeks(weeksToAdd));
	}
	...
	public static Date plusDays(Date date, long daysToAdd) {
		return DateUtilss.plus(date, Duration.ofDays(daysToAdd));
	}
	...
	public static Date plusHours(Date date, long hoursToAdd) {
		return DateUtilss.plus(date, Duration.ofHours(hoursToAdd));
	}
	...
	public static Date plusMinutes(Date date, long minutesToAdd) {
		return DateUtilss.plus(date, Duration.ofMinutes(minutesToAdd));
	}
	...
	public static Date plusSeconds(Date date, long secondsToAdd) {
		return DateUtilss.plus(date, Duration.ofSeconds(secondsToAdd));
	}
	...
	public static Date plusMillis(Date date, long millisToAdd) {
		return DateUtilss.plus(date, Duration.ofMillis(millisToAdd));
	}
	...
	public static Date plusNanos(Date date, long nanosToAdd) {
		return DateUtilss.plus(date, Duration.ofNanos(nanosToAdd));
	}
	...
	public static Date minusYears(Date date, int years) {
		return DateUtilss.set(date, Calendar.YEAR, -years);
	}
	...
	public static Date minusMonths(Date date, int months) {
		return DateUtilss.set(date, Calendar.MONTH, -months);
	}
	...
	public static Date minusWeeks(Date date, int weeks) {
		return DateUtilss.minus(date, Period.ofWeeks(weeks));
	}
	...
	public static Date minusDays(Date date, long days) {
		return DateUtilss.minus(date, Duration.ofDays(days));
	}
	...
	public static Date minusHours(Date date, long hours) {
		return DateUtilss.minus(date, Duration.ofHours(hours));
	}
	...
	public static Date minusMinutes(Date date, long minutes) {
		return DateUtilss.minus(date, Duration.ofMinutes(minutes));
	}
	...
	public static Date minusSeconds(Date date, long seconds) {
		return DateUtilss.minus(date, Duration.ofSeconds(seconds));
	}
	...
	public static Date minusMillis(Date date, long millis) {
		return DateUtilss.minus(date, Duration.ofMillis(millis));
	}
	...
	public static Date minusNanos(Date date, long nanos) {
		return DateUtilss.minus(date, Duration.ofNanos(nanos));
	}
	...
	public static Date toDate(LocalDateTime dateTime) {
		return Date.from(DateUtilss.toInstant(dateTime));
	}
