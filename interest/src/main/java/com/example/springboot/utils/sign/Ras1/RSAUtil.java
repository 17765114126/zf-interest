package com.example.springboot.utils.sign.Ras1;

//import com.zeekrlife.micro.mpcar.utils.NFCSign.SignAndVerifyUtil;
...
public class RSAUtil {
    ...
    public static void main(String[] args) {
        String source = "fwedscsc";
        System.out.println("明文字符串：[" + source + "]");
        try{
            //生成可用的密钥对并分别保存在文件中
//            generateKeyPair();

//            ClassLoader classLoader = SignAndVerifyUtil.class.getClassLoader();
//      获取私钥
//            URL resource = classLoader.getResource("aliver_1711_fmsh_test_rsa2048pripk8.pem");
//            String privateKeyPath = resource.getPath();
//        获取公钥
//            resource = classLoader.getResource("aliver_1711_fmsh_test_rsa2048pub.pem");
//            String publicKeyPath = resource.getPath();

//            System.out.println("生成的公钥文件为：" + publicKeyPath + ", 生成的私钥文件为：" + PRIVATE_KEY_FILE);
//            String cryptograph = encrypt(source, publicKeyPath);//生成的密文
//            System.out.println("加密之后的字符串为：[" + cryptograph + "]");
//            String text = decrypt(cryptograph, privateKeyPath);//解密密文
