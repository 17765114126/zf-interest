...
import com.example.application.utils.Validator.ArgumentInvalidResult;
...
public class ValidationException extends RuntimeException {
     ...
     * 记录异常信息
     */
    private List<com.example.application.utils.Validator.ArgumentInvalidResult> invalidResultList = Lists.newArrayList();
    ...
    public void addErrInfo(String field,Object rejectedValue,String defaultMessage){
        com.example.application.utils.Validator.ArgumentInvalidResult argumentInvalidResult = new ArgumentInvalidResult();
